...
# st.markdown("""""")
applogo, empty1,empty4, mission,empty2, persona, thing, empty3, empty5  = st.beta_columns(9)
...
with plus_col:    
    st.image("https://raw.githubusercontent.com/rizMehdi/IoTgo/main/images/blankcard.png", width=vertiPaddingWidth+25)
